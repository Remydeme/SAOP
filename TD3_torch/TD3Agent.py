...
from TD3_torch.ActorModel import ActorModel
from TD3_torch.CriticModel import CriticModel
...
class Agent:
    ...
    def __init__(self, env, game, critic_lr=1e-3, actor_lr=1e-3, target_action_noise=0.2, action_noise=0.1,
                 buffer_size=1000000):
    ...
    def updateNetworks(self, iterations, batch_size=100, discount=0.99, tau=0.005, policy_noise=0.2,
        ...
        for it in range(iterations):
            ...
            low_action = float(self.env.action_space.low[0])
            next_action = (self.actor_target(next_state) + noise).clamp(low_action, max_action)
